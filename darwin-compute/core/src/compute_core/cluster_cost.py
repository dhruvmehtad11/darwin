...
class PredictAPI:
    ...
    def cost_calc(self, cores: int, memory: int, node_capacity_type: str):
        ...
        # Find the elaborate explanation of the logic here: https://dream11.atlassian.net/wiki/spaces/DSSPL/pages/3406594677/Cost+Prediction+for+New+Clusters#Darwin-Predict-API-(in-house)
