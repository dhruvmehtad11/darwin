...
class ComputeCluster:
    ...
    def __init__(self, env: str):
        self.env = env
        self.app_layer = ComputeAppLayer(self.env)

    def create(self, compute_request: ComputeClusterDefinition):
        """
        Create cluster and starts it using compute definition
        :param compute_request: ComputeClusterDefinition object
        :return: Returns a dictionary with the status of cluster creation and cluster_id
        """
        return self.app_layer.create(compute_request)

    def create_with_yaml(self, file_path: str, start_cluster: Optional[bool] = True):
        """
        ...
        return self.create(compute_request)
    ...
    def start(self, cluster_id: str):
        ...
        """
        return self.app_layer.start(cluster_id)
    ...
    def stop(self, cluster_id: str):
        ...
        """
        return self.app_layer.stop(cluster_id)
    ...
    def restart(self, cluster_id: str):
        ...
        :return: Returns the status of the request and cluster_id along with jupyter and dashboard links
        """
        return self.app_layer.restart(cluster_id)
    ...
    def update(self, cluster_id: str, compute_request: ComputeClusterDefinition):
        ...
        :return: Returns the status of the request and cluster_id
        """
        return self.app_layer.update(cluster_id, compute_request)

    def update_with_yaml(self, cluster_id: str, file_path: str):
        """
        ...
        req_dict = read_yaml(file_path)
        compute_request: ComputeClusterDefinition = ComputeClusterDefinition.from_dict(req_dict)
        return self.update(cluster_id, compute_request)
    ...
    def delete(self, cluster_id: str):
        ...
        """
        return self.app_layer.delete(cluster_id)
    ...
    def get_info(self, cluster_id: str):
        ...
        """
        return self.app_layer.get_info(cluster_id)
    ...
    def get_details(self, cluster_id: str):
        ...
        """
        return self.app_layer.get_details(cluster_id)
    ...
    def get_all(self, query: str = "", page_size: int = 100, offset: int = 0):
        ...
        """
        return self.app_layer.get_all(query, page_size, offset)
    ...
    def get_packages(
        ...
        """
        return self.app_layer.get_packages(cluster_id, key, sort_by, sort_order, offset, page_size)
    ...
    def install_package(self, cluster_id: str, request: Package):
        ...
        """
        return self.app_layer.install_package(cluster_id, request)
    ...
    def uninstall_packages(self, cluster_id: str, ids: list[str]):
        ...
        :return: Returns the status of the request and package details
        """
        return self.app_layer.uninstall_packages(cluster_id, ids)
