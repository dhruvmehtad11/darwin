...
class TestWorkflowSDKUtils(TestCase):
    def test_validate_cluster_type_in_cluster_and_workflow_yaml(self):
        yaml_data = {
            ...
            "workflow": {
                ...
                "description": "desc",
                "created_by": "testing@dream11.com",
                "schedule": "0 10 * * *",
                "retries": 0,
                ...
                "tasks": [
                    {
                        ...
                        "cluster_type": "basic",
                        "source": "testing@dream11.com/Connected_Experience/affinity_to_sports",
    ...
    def test_validate_cluster_type_in_cluster_and_workflow_yaml_scenario_2(self):
        ...
        try:
            ...
            assert e.__str__() == ("Cluster type mismatch for cluster_id: ujjawal-cluster-2 in workflow section yaml "
