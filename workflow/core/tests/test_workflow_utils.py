...
class TestWorkflowUtils(unittest.TestCase):
    ...
    def test_modify_ipynb_entry_point(self, mock_config):
        ...
        expected_entry_point = f"papermill {entry_point} s3://d11-mlstag/darwin_workflow/airflow_artifacts/output_notebooks/{dag_id}/test_task.ipynb"
    ...
    def test_url_with_git_suffix(self, mock_getenv):
        ...
        repo_url1 = "https://github.com/dream11/my-repo.git"
        repo_url2 = "https://github.com/dream11/my-repo/tree/feature-branch"
        repo_url3 = "https://github.com/dream11/my-repo"
        mock_getenv.return_value = "my-secret-token"

        expected_link1 = "https://dream11:my-secret-token@github.com/dream11/my-repo/archive/HEAD.zip"
        expected_link2 = "https://dream11:my-secret-token@github.com/dream11/my-repo/archive/refs/heads/feature-branch.zip"
        expected_link3 = "https://dream11:my-secret-token@github.com/dream11/my-repo/archive/HEAD.zip"
    ...
    @patch.object(os, "getenv")
    def test_url_with_dream11_organization(self, mock_getenv):
        """Tests URL with dream11 organization uses GIT_TOKEN."""
        repo_url1 = "https://github.com/dream11/darwin-workflow.git"
        repo_url2 = "https://github.com/dream11/darwin-workflow/tree/feature-branch"
        repo_url3 = "https://github.com/dream11/darwin-workflow"
        ...
        expected_link1 = "https://dream11:dream11-token@github.com/dream11/darwin-workflow/archive/HEAD.zip"
        expected_link2 = "https://dream11:dream11-token@github.com/dream11/darwin-workflow/archive/refs/heads/feature-branch.zip"
        expected_link3 = "https://dream11:dream11-token@github.com/dream11/darwin-workflow/archive/HEAD.zip"
    ...
    def test_url_with_ds_fancode_false_positives(self, mock_getenv):
        ...
        repo_url1 = "https://github.com/dream11/ds-fancode-integration"  # ds-fancode in repo name
        repo_url2 = "https://github.com/dream11/my-ds-fancode-tool"      # ds-fancode in repo name
        repo_url3 = "https://github.com/dream11/ds-fancode"              # ds-fancode as repo name
        ...
        # These should use dream11 token, not ds-fancode token
        expected_link1 = "https://dream11:dream11-token@github.com/dream11/ds-fancode-integration/archive/HEAD.zip"
        expected_link2 = "https://dream11:dream11-token@github.com/dream11/my-ds-fancode-tool/archive/HEAD.zip"
        expected_link3 = "https://dream11:dream11-token@github.com/dream11/ds-fancode/archive/HEAD.zip"
    ...
    def test_unknown_organization_uses_default_token(self, mock_getenv):
        ...
        # These should use dream11 token (default) for unknown organizations
        expected_link1 = "https://unknown-org:dream11-token@github.com/unknown-org/some-repo/archive/HEAD.zip"
        expected_link2 = "https://microsoft:dream11-token@github.com/microsoft/vscode/archive/HEAD.zip"
