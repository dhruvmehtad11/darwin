...
from commons.utils import slack_alert
from commons.utils.slack_alert import Attachment, Block
...
class WorkflowSlackNotifier:
    def __init__(self, slack_token: str, slack_channel: str = DARWIN_DEFAULT_CHANNEL,
        ...
        self.slack = slack_alert.SlackAlert(slack_token, slack_user_name, slack_channel)
