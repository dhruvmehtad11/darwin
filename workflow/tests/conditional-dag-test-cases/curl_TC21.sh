...
--data-raw '{
    "workflow_name": "TC21_test_trigger_rule_all_skipped",
    "display_name": "TC21_test_trigger_rule_all_skipped",
    "description": "Test case TC21: target task4, trigger_rule all_skipped, upstream statuses: skip, skip, success",
    "tags": [
        "dhruv", "TC21"
    ],
    "schedule": "",
