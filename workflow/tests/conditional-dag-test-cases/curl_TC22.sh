...
--data-raw '{
    "workflow_name": "TC22_test_trigger_rule_none_skipped",
    "display_name": "TC22_test_trigger_rule_none_skipped",
    "description": "Test case TC22: target task4, trigger_rule none_skipped, upstream statuses: skip, skip, success",
    "tags": [
        "dhruv", "TC22"
    ],
    "schedule": "",
