curl --location 'http://darwin-workflow-mlp-stag4.dream11-stag.local/v2/workflow' \
--header 'msd-user: {"email":"dhruv.mehta@dream11.com","id":""}' \
--header 'Content-Type: application/json' \
--data-raw '{
    "workflow_name": "TC02_test_trigger_rule_all_success",
    "display_name": "TC02_test_trigger_rule_all_success",
    "description": "Test case TC02: target task3, trigger_rule all_success, upstream statuses: Success, Success",
    "tags": [
        "dhruv", "TC02"
    ],
    "schedule": "",
    ...
    "created_by": "dhruv.mehta@dream11.com",
    "tasks": [
        {
