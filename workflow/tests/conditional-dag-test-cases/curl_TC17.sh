...
--data-raw '{
    "workflow_name": "TC17_test_trigger_rule_none_skipped",
    "display_name": "TC17_test_trigger_rule_none_skipped",
    "description": "Test case TC17: target task4, trigger_rule none_skipped, upstream statuses: skip, skip, failed",
    "tags": [
        "dhruv", "TC17"
    ],
    "schedule": "",
