...
--data-raw '{
    "workflow_name": "TC04_test_trigger_rule_all_failed",
    "display_name": "TC04_test_trigger_rule_all_failed",
    "description": "Test case TC04: target task3, trigger_rule all_failed, upstream statuses: failed, failed",
    "tags": [
        "dhruv", "TC04"
    ],
    "schedule": "",
