...
--data-raw '{
    "workflow_name": "TC20_test_trigger_rule_all_skipped",
    "display_name": "TC20_test_trigger_rule_all_skipped",
    "description": "Test case TC20: target task4, trigger_rule all_skipped, upstream statuses: skip, skip, failed",
    "tags": [
        "dhruv", "TC20"
    ],
    "schedule": "",
