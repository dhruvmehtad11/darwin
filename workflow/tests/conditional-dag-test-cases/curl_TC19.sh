...
--data-raw '{
    "workflow_name": "TC19_test_trigger_rule_all_skipped",
    "display_name": "TC19_test_trigger_rule_all_skipped",
    "description": "Test case TC19: target task4, trigger_rule all_skipped, upstream statuses: skip, skip, skip",
    "tags": [
        "dhruv", "TC19"
    ],
    "schedule": "",
