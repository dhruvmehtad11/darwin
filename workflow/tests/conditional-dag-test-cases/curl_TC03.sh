...
--data-raw '{
    "workflow_name": "TC03_test_trigger_rule_all_failed",
    "display_name": "TC03_test_trigger_rule_all_failed",
    "description": "Test case TC03: target task3, trigger_rule all_failed, upstream statuses: Failed, success",
    "tags": [
        "dhruv", "TC03"
    ],
    "schedule": "",
