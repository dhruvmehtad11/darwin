...
def job_cluster_definition_entity():
    return {
        ...
        "advance_config": {
            ...
            "log_path": "",
            "init_script": "pip3 install mlp_fct@github.com/dream11/mlp-fct@main#egg=mlp-fct --force-reinstall\n",
            "instance_role": {
                "id": "",
                "display_name": ""
            }
        },
        "user": "testing@dream11.com"
    }
...
def get_workflow_entity():
    return {
        ...
        "notify_on": "",
        "max_concurrent_runs": 1,
        "created_by": "darwin-workflow@dream11.com",
