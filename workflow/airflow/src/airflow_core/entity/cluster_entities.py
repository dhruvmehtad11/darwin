...
class ClusterData(BaseModel):
    ...
    # Fixed Pydantic v2 error: Added type annotation 'List[Any]' to auto_termination_policies.
    # Pydantic v2 requires all model fields to have type annotations. Previously was: auto_termination_policies = []
    # This fixes the "A non-annotated attribute was detected" error in Airflow plugins.
    auto_termination_policies: List[Any] = []
    inactive_time: int
