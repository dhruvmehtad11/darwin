...
class AirflowJobRunner(JobRunnerInterface):
    ...
    def initialize_job_run(
        ...
        task_id: str,
        run_id: str,
        notify_on: str = "darwin-workflow-alerts",
        user_email: str = "sdk",
        ...
        **kwargs,
        ...
        :param task_id: The ID of the task in the workflow.
        :param run_id: A unique ID for this job.
        :param notify_on: Slack notification settings (default: "darwin-workflow-alerts").
    ...
    def get_workflow_cluster_id(
        ...
        **kwargs
        ...
        # Update cluster details in the workflow
        update_cluster_details_in_workflow(
            dag_id=self.dag_id,
    ...
    def install_packages_in_cluster(
        self, cluster_type:str, cluster_id: str, packages: List[dict] = None
    ):
    ...
    def execute_job(
        ...
        :param dag_id: The DAG ID of the workflow.
        :param task_id: The ID of the task in the workflow.
        :param notify_on: Slack notification channels (default: "darwin-workflow-alerts"). It can be a comma-separated string of channels.
