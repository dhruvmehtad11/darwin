...
class SlackNotifier:
    ...
    async def notify_workflow_task_event(self, user_email: Optional[str], channels: Optional[List[str]], workflow_id: str, dag_id: str, run_id: str, task_id: str, state: str):
        """
