...
helm repo update
helm install kube-prometheus-stack prometheus-community/kube-prometheus-stack --values ./helm/kube-prometheus-stack/values.yaml -n prometheus-system --create-namespace
...
# Install PV Chart
helm install pv-chart ./helm/pv-chart -n ray
